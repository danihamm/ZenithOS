...
#else /* !__MONTAUKOS__ -- original TCC headers */
...
/* MontaukOS paths use "N:/path" so ':' can't be the path separator */
# define IS_DIRSEP(c) (c == '/')
# define IS_ABSPATH(p) ((p[0] >= '0' && p[0] <= '9') && p[1] == ':' && p[2] == '/')
